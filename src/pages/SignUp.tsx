      ...
      >
        ...
        >
          <motion.div className="mb-10" variants={itemVariants}>
            ...
            <h2 className="heading-4 text-white mb-2">Create your account</h2>
            <p className="text-white/50">Start your journey to academic excellence</p>
          </motion.div>
            ...
            <div className="space-y-5">
              ...
              <div className="input-group">
                ...
                <select
                  ...
                  onChange={handleChange}
                  onFocus={() => setFocusedField('educationStage')}
                  onBlur={() => setFocusedField(null)}
                  className="input"
                  required
                >
              ...
              <label className="flex items-start gap-3 text-sm text-white/60 cursor-pointer hover:text-white/80 transition-colors pt-2">
                <input
                  type="checkbox"
                  className="w-4 h-4 mt-0.5 rounded border-white/20 bg-white/5 accent-accent-purple"
                  required
                />
                <span>
                  I agree to the{' '}
                  <a href="#" className="text-accent-purple hover:text-accent-purple-light transition-colors">
                    Terms of Service
                  </a>{' '}
                  and{' '}
                  <a href="#" className="text-accent-purple hover:text-accent-purple-light transition-colors">
          ...
          <motion.div className="mt-8" variants={itemVariants}>
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-dark-800 text-white/50">Or sign up with</span>
              </div>
            </div>
